...
function custom_theme_options() {
  ...
  $custom_settings = array( 
	...
	'sections'        => array(
      ...
      array(
        'id'          => 'slidershow',
        'title'       => __('Slidershow','cactus')
      ),
      array(
        'id'          => 'banner',
        'title'       => __('Banner Trang chủ','cactus')
      ),     
	  array(
        'id'          => 'footer',
        'title'       => __('Footer','cactus')
      ),
	  array(
        'id'          => 'company',
        'title'       => __('Thông tin công ty','cactus')
      )
    ),
    'settings'        => array(
      array(
        'id'          => 'logo',
        'label'       => __('Logo','cactus'),
        'desc'        => __('Upload file logo','cactus'),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'general',
        'rows'        => '',
      ...
      array(
        'id'          => 'banner',
        'label'       => __( 'Upload ảnh banner trên đầu trang', 'cactus' ),
        'desc'        => 'Upload ảnh banner trên đầu trang',
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'general',
        'rows'        => '',
	  ...
	  array(
        'id'          => 'category',
        'label'       => __( 'Chọn dòng sản phảm hiển thị ra trang chủ', 'cactus' ),
        'desc'        => 'Chọn slug cho dòng sản phẩm',
        'std'         => '',
	  ...
	  array(
        'id'          => 'text_footer',
        'label'       => __( 'Thêm đoạn text bên trái dưới footer', 'cactus' ),
        'desc'        => 'Thêm đoạn text bên trái dưới footer',
        'std'         => '',
      ...
      array(
        'id'          => 'slidershow',
        'label'       => __( 'Thêm ảnh và đến slidershow trang chủ', 'theme-text-domain' ),
        'desc'        => __( 'Thêm ảnh và link liên kết cho slideshow trang chủ' ),
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'slidershow',
        'rows'        => '',
        ...
        'settings'    => array( 
          array(
            ...
            'label'       => __( 'load ảnh slidershow', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'upload',
            'rows'        => '10',
		  ...
		  array(
            'id'          => 'link_post',
            'label'       => __( 'Gán link đến bài viết hoặc sản phẩm', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'text',
            'rows'        => '',
		  ...
		  array(
            'id'          => 'title1',
            'label'       => __( 'Thêm text1 cho ảnh slideshow', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'text',
            'rows'        => '',
            ...
            'id'          => 'title2',
            'label'       => __( 'Thêm text2 cho ảnh slideshow', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'text',
            'rows'        => '',
      ...
      array(
        'id'          => 'banner2',
        'label'       => __( 'Upload 3 ảnh banner ngay bên dưới slideshow ở trang chủ', 'theme-text-domain' ),
        'desc'        => __( 'Upload 3 ảnh banner ngay bên dưới slideshow' ),
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'banner',
        'rows'        => '',
        ...
        'settings'    => array( 
          array(
            'id'          => 'imagebanner1',
            'label'       => __( 'load ảnh banner', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'upload',
            'rows'        => '10',
		  ...
		  array(
            'id'          => 'link_banner',
            'label'       => __( 'Gán link cho banner', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'text',
            'rows'        => '',
      ...
      array(
        'id'          => 'banner3',
        'label'       => __( 'Upload 2 banner bên trái dưới tabs sản phẩm', 'theme-text-domain' ),
        'desc'        => __( 'Upload 2 banner bên trái dưới tabs sản phẩm' ),
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'banner',
        'rows'        => '',
        ...
        'settings'    => array( 
          array(
            'id'          => 'imagebanner2',
            'label'       => __( 'load 2 ảnh banner bên trái', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'upload',
            'rows'        => '10',
      ...
      array(
        'id'          => 'banner4',
        'label'       => __( 'Upload 2 banner bên phải dưới tabs sản phẩm', 'theme-text-domain' ),
        'desc'        => __( 'Upload 2 banner bên phải dưới tabs sản phẩm' ),
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'banner',
        'rows'        => '',
        ...
        'settings'    => array( 
          array(
            'id'          => 'imagebanner2',
            'label'       => __( 'load 2 ảnh banner bên phải', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'textarea-simple',
            'rows'        => '10',
	  ...
	  array(
        'id'          => 'infocompany',
        'label'       => __( 'Thông tin liên hệ', 'theme-text-domain' ),
        'desc'        => __( 'Nhập thông tin về công ty' ),
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'company',
        'rows'        => '',
        ...
        'settings'    => array( 
          array(
            'id'          => 'name',
            'label'       => __( 'Nhập tên công ty', 'theme-text-domain' ),
            'desc'        => '',
            'std'         => '',
            'type'        => 'text',
            'rows'        => '10',
		  ...
		  array(
				'id'          => 'address',
				'label'       => __( 'Nhập địa chỉ công ty, cơ quan nơi làm việc', 'theme-text-domain' ),
				'desc'        => '',
				'std'         => '',
				'type'        => 'textarea-simple',
				'rows'        => '10',
			...
			array(
				'id'          => 'phone',
				'label'       => __( 'Nhập số điện thoại (hotline) công ty, cơ quan nơi làm việc', 'theme-text-domain' ),
				'desc'        => '',
				'std'         => '',
				'type'        => 'text',
				'rows'        => '10',
			...
			array(
				'id'          => 'email',
				'label'       => __( 'Nhập địa chỉ Email công ty, cơ quan nơi làm việc', 'theme-text-domain' ),
				'desc'        => '',
				'std'         => '',
				'type'        => 'text',
				'rows'        => '10',
	...
	/* Below are sample Theme Options Elements */
	/*
    'sections'        => array( 
      array(
        'id'          => 'option_types',
